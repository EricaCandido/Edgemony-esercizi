...
// ESERCIZIO 1.1 un metodo forEach che stampi in console.log i soli ID di ogni singolo elemento

// todos.forEach((item) => console.log(item.id));

// ESERCIZIO 1.2 un metodo map che memorizzi in una variabile tutti gli userId di ogni singolo elemento e
// quindi richiamarli con un console.log a parte

// const userId = todos.map((item) => item.id);
// console.log(userId);

// ESERCIZIO 1.3 un metodo filter che stampi in console.log i soli ID di ogni singolo elemento i cui valori
// siano maggiori o uguali a 4

// const fromFour = todos.filter((item) => item.id >= 4);
// console.log(fromFour);
...
notes.map((item) => todoGenerator(item.id));
