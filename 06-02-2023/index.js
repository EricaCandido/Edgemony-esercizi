...
const myFavBooks=(lista)=>books.filter((book)=>(book.pages<300))
...
app.get('/api/books', (req,res)=>{
    res.sendFile(path.resolve(__dirname, 'books.json'))
})

app.get('/api/fav-books', authorize, (req,res)=>{
    res.send(myFavBooks(books))
})
