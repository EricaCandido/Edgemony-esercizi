/*ESERCIZIO 1 
ulla base della lezione del giorno, creare una nuova funzione che funzioni esattamente 
...
function myParser(nFloat) {
  return nFloat.toFixed();
}

console.log(myParser(10.5));*/

//In questà prima modalità il metodo arrotonda per eccesso o per difetto a seconda del
//caso; in quella che segue, la funzione restituisce solo ciò che trova prima del
//carattere '.'

/*
SOLUZIONE N°2

function myParser1(nFloat) {
  const s = String(nFloat);
  return s.split(".")[0];
}
console.log(myParser1(10.5));*/
...
function advanced(allProd) {
  for (let ob of allProd) {
    console.log(ob.title);
    console.log(ob.price);
    console.log(ob.rating.count);
    console.log("------------");
  }
}
